...
export default function NewBlogPortal ({ open, onSave, onCancel }) {
    ...
    const mySchema = yup.object().shape({
        ...
        body: yup.string().min(50, 'Too short').required('You need a body for a blog.'),
    })
        ...
        <Portal open={open}>
            <Segment style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)' }} color="orange">
                <Form style={{ width: '300px', height: '300px' }} onSubmit={formik.handleSubmit}>
                    <div>
                        <Label htmlFor='title' color="orange">Title:</Label>
                        <TextArea
                            style={{
                                width: '100%',
                                resize: 'none',
                    ...
                    <div>
                        <Label htmlFor='body' color='orange'>Body:</Label>
                        <TextArea 
                            style={{
                                width: '100%',
                                resize: 'none',
